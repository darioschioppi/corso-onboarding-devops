...
> 📄 **[Scarica questa sezione in PDF](https://darioschioppi.github.io/corso-onboarding-devops/pdf/05-agile.pdf)** — utile per la stampa o la lettura offline.
...
Vale la pena essere altrettanto onesti sui limiti dell'Agile, perché come futuro Project Manager li incontrerai davvero, non solo sui libri. Ci sono contesti in cui un impianto rigoroso di documentazione e pianificazione anticipata non è una preferenza di metodo, ma un obbligo: un contratto **a prezzo e perimetro fissi** (fixed price, fixed scope), firmato prima di iniziare, lascia poco spazio ad "adattarsi durante il progetto" se il cliente vuole sapere fin da subito esattamente cosa riceverà e quanto pagherà. Allo stesso modo, settori **regolamentati** — farmaceutico, bancario, aerospaziale — impongono per legge una documentazione formale e tracciabile di ogni fase, non perché sia "più prudente", ma perché un'autorità di controllo esterna la richiede esplicitamente, a prescindere da quanto il team sia bravo a lavorare in modo agile. Infine, l'Agile nasce pensato per un **singolo team**: quando un progetto richiede di coordinare venti o trenta persone su più team in parallelo, le pratiche che funzionano bene per 7-8 persone (un daily di 15 minuti, una board condivisa, una retrospettiva) non si scalano da sole, e serve un livello di coordinamento aggiuntivo che l'Agile "puro" non descrive — è proprio il problema che vedrai tra poco a proposito di SAFe.
...
Nello schema qui sopra hai notato una terza voce, **SAFe** (Scaled Agile Framework), accennata solo come "altro framework". Merita due righe di spiegazione perché nasce da un problema molto concreto: Scrum e Kanban funzionano bene per un singolo team di poche persone, ma non dicono nulla su come far collaborare venti team che lavorano sullo stesso prodotto. SAFe è uno dei tentativi più diffusi di rispondere a questa domanda, aggiungendo livelli di pianificazione e coordinamento sopra i singoli team Scrum/Kanban. È anche, va detto, uno dei framework più discussi: molti professionisti Agile lo criticano proprio perché la sua struttura, con ruoli e riti aggiuntivi a livello di programma e di portafoglio, rischia di reintrodurre la burocrazia e la rigidità che l'Agile era nato per superare.
...
Prima di passare alla pratica, vale la pena spendere due righe anche sulle critiche più recenti che vengono fatte all'Agile, perché come Project Manager dovrai saperle riconoscere per non subirle senza accorgertene. La prima è il rischio di **sprint consecutivi senza respiro**: un team che consegna ogni due settimane, per anni, senza mai una pausa strutturale tra un ciclo di lavoro e il successivo, può arrivare a un ritmo insostenibile — l'Agile parla esplicitamente di "ritmo sostenibile" (l'hai visto nel Tema 6 di 5.3), ma nella pratica quotidiana questo principio è spesso il primo a essere sacrificato quando le scadenze si accumulano. La seconda critica riguarda un uso distorto e comodo della parola stessa: "siamo agili" viene talvolta usato come alibi per non pianificare mai nulla oltre le prossime due settimane, anche quando un minimo di visione a medio termine (che vedrai nella sezione sul Project Management) sarebbe utile sia al team che al cliente. L'Agile ben applicato non è un rifiuto della pianificazione: è pianificare in modo diverso, non smettere di pianificare.
