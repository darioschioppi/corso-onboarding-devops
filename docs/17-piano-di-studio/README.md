...
- **Il Glossario (sezione 16) è il tuo compagno silenzioso per tutte le 9 settimane.** Ogni volta che incontri un termine che non ricordi — anche uno già visto — torna lì. Non è un segno di scarsa preparazione: è esattamente lo scopo per cui esiste.
- **Non aspettarti di "sapere tutto" alla settimana 9.** L'obiettivo del piano è darti l'autonomia per affiancare e poi sostituire la tua collega con sicurezza sulle basi, non farti diventare un esperto DevOps in due mesi. Il resto lo imparerai sul campo, con la sezione 19 (Risorse online) e la sezione 18 (Libri consigliati) a disposizione per gli approfondimenti che vorrai fare più avanti.
...
```mermaid
gantt
    title Piano di studio — 9 settimane di onboarding
    dateFormat  X
    axisFormat  Sett. %d
    ...
    Intelligenza artificiale               :s8, after s7, 1w

    section Consolidamento
    Ripasso generale + libri + risorse + autovalutazione :s9, after s8, 1w
```

Il percorso segue una logica a blocchi progressivi: prima il **linguaggio di base** del software (settimane 1-2), poi **il modo in cui il team si organizza** per lavorare (settimane 3-5, con Kanban e Project Management sdoppiati su due settimane separate per dare più respiro al vocabolario PMP/PMBOK), poi **gli strumenti e i processi specifici** della piattaforma DevOps che gestirai (settimana 6, DevOps e CI/CD insieme), poi il **contesto tecnico e trasversale** che ti serve per capire le decisioni del team (settimana 7), poi un approfondimento su **come l'intelligenza artificiale entra nel lavoro quotidiano del team** (settimana 8), e infine un momento di **consolidamento** (settimana 9) prima di sentirti pronto/a a camminare sempre più da solo/a.
...
## Settimana 8 — Intelligenza artificiale: come entra nel lavoro quotidiano del team

| | |
|---|---|
| **Argomenti** | [Sezione 15 — Intelligenza artificiale](../15-intelligenza-artificiale/README.md) |
| **Tempo stimato** | 7-9 ore (sezione di lunghezza media-alta: vocabolario nuovo — Machine Learning, LLM, AI generativa — più esempi pratici legati a strumenti come GitHub Copilot) |

**Esercizi pratici**

1. Chiedi a un developer del team (ad esempio Marco o Ahmed) di mostrarti, per qualche minuto, come usa uno strumento di AI generativa nel lavoro quotidiano (es. un suggerimento di GitHub Copilot durante la scrittura di una funzione) e osserva come lo verifica prima di accettarlo.
2. Scrivi tre esempi di Prompt che potresti usare per chiedere aiuto a un assistente AI su compiti tipici del tuo ruolo (es. riassumere le note di una Daily Scrum, preparare la scaletta di una Sprint Review), e provali se hai accesso a uno strumento del genere.
3. Discuti con la tua collega un caso reale (anche ipotetico) di Allucinazione o di risposta imprecisa di un assistente AI: come se ne accorge il team, e cosa fa per evitare che un errore di questo tipo arrivi in produzione.
4. Prova a spiegare a parole tue, senza guardare gli appunti, la differenza tra Training e Inferenza usando l'esempio di GitHub Copilot: quando "impara" il modello e quando invece lo stai semplicemente "usando".

**Obiettivi di apprendimento**

Al termine della settimana devi saper:

- distinguere AI, Machine Learning e Deep Learning, e spiegare cosa sono Training e Inferenza;
- spiegare cos'è un LLM e cosa si intende per AI generativa, con GitHub Copilot come esempio concreto;
- riconoscere i limiti principali di questi strumenti (Allucinazione, Bias, Overfitting) e perché serve sempre una verifica umana;
- spiegare a grandi linee cosa sono MLOps e AIOps e come si collegano ai principi DevOps già visti nella settimana 6.

**Verifica finale della settimana**

Sai spiegare a un collega non tecnico perché un suggerimento di GitHub Copilot va sempre passato in Code Review come qualsiasi altro contributo, e non accettato "alla cieca" solo perché generato da uno strumento AI?

---

## Settimana 9 — Consolidamento: ripasso generale, autovalutazione e prossimi passi
...
2. Prepara una "mappa mentale" (anche a mano, su un foglio) che collega i temi principali del corso: Agile → Scrum/Kanban → Project Management → DevOps → CI/CD → Cloud/Sicurezza → Intelligenza artificiale. Non deve essere perfetta, deve aiutarti a vedere le connessioni.
3. Fissa un colloquio conclusivo di 45-60 minuti con la tua collega Scrum Master/PM in cui **tu** guidi la conversazione: racconta con parole tue come funziona il progetto, dal punto di vista di processo (Scrum/Kanban) e di piattaforma (GitHub, pipeline, ambienti, strumenti AI). Fatti correggere dove serve.
...
- muoverti con sicurezza nella conversazione quotidiana del team, sia sul piano di processo che su quello tecnico di base, incluso l'uso responsabile di strumenti AI;
...
## Tabella riepilogativa delle 9 settimane
...
- [18. Libri consigliati](../18-libri-consigliati/README.md) — approfondimenti da leggere con calma dopo aver completato le 9 settimane
...
- [Learning How to Learn (Coursera, Barbara Oakley)](https://www.coursera.org/learn/learning-how-to-learn) — corso gratuito molto pratico su tecniche di apprendimento efficace, utile per organizzare meglio lo studio in 9 settimane
